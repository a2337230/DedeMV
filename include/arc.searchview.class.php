...
class SearchView
{
    ...
    function GetPageListDM($list_len)
    {
        ...
        // $infos = "<li>共".$this->TotalResult."</b>条记录/最大显示<b>{$totalpage}</b>页 </li>\r\n";
        $infos = "<li>共<span class=totalsize>{$totalpage}</span>页/".$this->TotalResult."条</li>";
        ...
        $plist = "<ul name='pagelist' action='".$this->GetCurUrl()."'>$hidenform";
        $plist .= $infos;
        $plist .= $indexpage;
        $plist .= $prepage;
        $plist .= $listdd;
